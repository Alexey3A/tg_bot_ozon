...
public class Bot extends TelegramLongPollingBot {
    ...
    private static final String infoCommand = "Бот предоставляет информацию о стоимости товаров на Ozon без учета Ozon карты. \n"
    ...
    public void onUpdateReceived(Update update) {
        ...
        org.example.tg_bot_ozon.entity.Message personMessage = new org.example.tg_bot_ozon.entity.Message(article, System.currentTimeMillis());
